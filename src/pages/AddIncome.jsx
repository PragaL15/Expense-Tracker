...
// Helper: get current date in YYYY-MM-DD format (adjusted to local timezone)
...
const AddIncome = () => {
  ...
  // Derived numeric amount (with validation)
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await API.get("/v1/categories?type=Income");
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await API.post("/v1/transactions/income", {
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4">
            ...
            <div className="relative">
              <input
                type="date"
                className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-3 focus:outline-none focus:ring-2 focus:ring-green-400"
                value={date}
              ...
              <span className="pointer-events-none absolute inset-y-0 right-3 flex items-center">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M8 7V3m8 4V3M4 11h16M5 20h14a1 1 0 0 0 1-1V7H4v12a1 1 0 0 0 1 1z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4">
            ...
            <textarea
              rows={4}
              className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-green-400 placeholder-gray-400"
